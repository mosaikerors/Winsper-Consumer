...
public interface UserService {
  ...
  JSONObject sendCode(HttpServletRequest request, String phone);

  @RequestMapping(value = "/signup", method = RequestMethod.POST)
  JSONObject signup(HttpSession session ,@RequestBody JSONObject request);

  @RequestMapping(value = "/login", method = RequestMethod.POST)
  JSONObject login(@RequestBody JSONObject request);

  @RequestMapping(value = "/updateInfo", method = RequestMethod.PUT)
  JSONObject updateInfo(@RequestHeader String token,@RequestBody JSONObject request);
}
